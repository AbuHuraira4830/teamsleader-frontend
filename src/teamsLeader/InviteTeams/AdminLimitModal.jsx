...
const AdminLimitModal = ({
  ...
  const plans = {
    trial: { clients: 1, name: "freelancer" },
    freelancer: { clients: 1, name: "business" },
    business: { clients: 25, name: "enterprise" },
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          You have reached the admin limit for the{" "}
...
export default AdminLimitModal;
