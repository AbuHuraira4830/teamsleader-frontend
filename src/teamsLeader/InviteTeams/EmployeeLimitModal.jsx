...
const EmployeeLimitModal = ({
  ...
  const plans = {
    trial: { employees: 0, name: "freelancer" },
    freelancer: { employees: 5, name: "business" },
    business: { employees: Infinity, name: "enterprise" },
    enterprise: { employees: Infinity, name: "enterprise" },
  };
      ...
      >
        ...
        {userPlan?.package === "trial" ? (
          ...
          >
            ...
            plan, which does not allow adding employees. Please upgrade to the{" "}
            <strong style={{ color: "#333" }}>
          ...
          <p
            ...
            style={{ fontSize: "15px", lineHeight: "1.7", color: "#666" }}
          >
            You have reached the employee limit for the{" "}
            <strong style={{ color: "#333" }}>
