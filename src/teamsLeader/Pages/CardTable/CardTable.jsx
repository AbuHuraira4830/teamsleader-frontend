...
const CardTable = ({
  ...
  const togglePasswordVisibility = (rowId) => {
    setShowCardNumbers((prevState) => ({
      ...prevState,
      [rowId]: !prevState[rowId], // Toggle the visibility state for the given row ID
    }));
  };
