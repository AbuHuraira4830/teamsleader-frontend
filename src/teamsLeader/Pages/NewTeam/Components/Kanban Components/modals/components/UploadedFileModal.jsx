...
import PreviewedFile from "../../SubComp/PreviewedFile";
import { useStateContext } from "../../../../../../../contexts/ContextProvider";
import { useKanbanContext } from "../../../../../../../contexts/KanbanContext";
// import { useStateContext } from "../../../../contexts/ContextProvider";
// import { useKanbanContext } from "../../../../../../contexts/KanbanContext";

const UploadedFileModal = ({ handleClose, taskId }) => {
  console.log({
    taskId,
  });
  const {
  ...
  const allFiles = data.tasks[openTaskId]?.files || [];
  console.log({
    allFiles,
  });
...
//   allFiles.findIndex((file) => file.url === modalData.file.url)
// );

  console.log({ modalData, currentItemIndex });
  ...
  useEffect(() => {
    console.log({currentIndexElem : allFiles[currentItemIndex]});
  }, [currentItemIndex]);
