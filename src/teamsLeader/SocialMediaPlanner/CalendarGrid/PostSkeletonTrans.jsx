...
const PostSkeletonTrans = () => {
  return (
    <div className=" plannerSkeleton_outermostTrans">
      <div className="plannerSkeleton_outer">
        <div className="plannerSkeleton_Trans"> </div>
        <div className="planner_SkeletonContainer ">
          <button className="planner_SkeletonWrapper planner_wrapperTrans">
      ...
      <div className="skeletonBox_wrapper skeletonTrans_wrapper">
...
export default PostSkeletonTrans;
