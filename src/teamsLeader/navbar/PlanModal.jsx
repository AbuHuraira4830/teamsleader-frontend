...
const PlanModal = ({
  ...
  const handleContinue = () => {
    ...
    const isDowngrade = planRanks[selectedPlan] < planRanks[currentPlan];

    // Perform downgrade check only if downgrading
    if (
      isDowngrade &&
      selectedPlanPermissions &&
      !canDowngrade(selectedPlanPermissions)
    ) {
  ...
  return (
    <>
      <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center">
        <div className=" rounded-lg overflow-y-auto w-11/12 md:w-3/4 lg:w-11/12 plansmodal_container">
          <div className="p-4 border-b pb-[.5rem]">
            ...
            <div className="flex items-center justify-center mt-[.5rem]">
              <h2 className="text-base">
                <span>
                  Thank you for choosing TeamsLeader! You have <b>14 days</b>{" "}
          ...
          <PlanFeatures
            ...
            features={features}
          />
          <div className="sticky bottom-0 planModal-bottom border-t p-4">
            <div className="flex justify-between items-center">
