...
const VideoFieldBox = ({ onFileChange, isHovered, videoUrl, block }) => {
  ...
  const handleFileChange = (event) => {
    ...
    if (file) {
      ...
      onFileChange(block.uid, blobUrl, "video");
    }
  };
  ...
  const handleVideoLoad = () => {
    const newHeight =
      videoHeightRef.current?.getBoundingClientRect().height || 0;
